...
class gd_nugget_meta {
    ...
    if( empty( $gd_nugget_post_type ) ) {
      if ( isset( $_GET['link_post'] ) ) {
        $gd_nugget_post_type = $_GET['link_post'];
		...
		echo '		<td>';
    echo '			<input ' . $disableField . ' type="text" id="gd_nugget_post_type" name="gd_nugget_post_type" class="gd_nugget_post_type_field" placeholder="' . esc_attr__( '', 'fanatic' ) . '" value="' . esc_attr( $gd_nugget_post_type ) . '">';
		echo '		</td>';
		echo '	</tr>';
