...
// Register Job Sector Taxonomy
function job_sector() {

    $labels = array(
        'name'                       => _x( 'Job Sectors', 'Taxonomy General Name', 'text_domain' ),
        'singular_name'              => _x( 'Job Sector', 'Taxonomy Singular Name', 'text_domain' ),
        'menu_name'                  => __( 'Job Sector', 'text_domain' ),
        'all_items'                  => __( 'All Items', 'text_domain' ),
        'parent_item'                => __( 'Parent Item', 'text_domain' ),
        'parent_item_colon'          => __( 'Parent Item:', 'text_domain' ),
        'new_item_name'              => __( 'New Item Name', 'text_domain' ),
    ...
    register_taxonomy( 'job-sector', array( 'jobs' ), $args );

}
add_action( 'init', 'job_sector', 0 );